...
<div class="container">
  ...
  <form method="post" class="mt-4">
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <input type="text" name="nis" oninput="validateNumeric(this)" pattern="[0-9]*" inputmode="numeric" maxlength="6" class="form-control" id="inputEmail3">
      </div>
    </div>
    <div class="row mb-3">
    ...
    <fieldset class="row mb-3">
      ...
      <div class="col-sm-10">
        <div class="form-check">
          <input class="form-check-input" type="radio" name="jk" id="gridRadios1" value="laki_laki">
